...
Public Const SpellColumns As Long = 11 '5
...
' Website
Public Const GAME_WEBSITE As String = "http://www.goplaygames.com.br"
...
' Map constants
Public Const MAX_MAPS As Long = 400
Public Const MAX_MAPX As Byte = 24
Public Const MAX_MAPY As Byte = 18
Public Const MAP_MORAL_NONE As Byte = 0
Public Const MAP_MORAL_SAFE As Byte = 1
Public Const MAP_MORAL_PRISON As Byte = 2
Public Const MAP_MORAL_OWNER As Byte = 1
...
Public Const DIALOGUE_TYPE_SELLPLANET As Byte = 4
Public Const DIALOGUE_TYPE_GUILDINVITE As Byte = 5
Public Const DIALOGUE_TYPE_ARENAINVITE As Byte = 6
Public Const DIALOGUE_TYPE_NAMEPLANET As Byte = 7
Public Const DIALOGUE_TYPE_CONFIRM As Byte = 8
Public Const DIALOGUE_TYPE_CONFIRMATION As Byte = 9
...
Public Const TutorialWaitTime As Long = 5000
Public Const PlayerAttackAnim As Byte = 1
Public Const ConstructAnim As Byte = 76
